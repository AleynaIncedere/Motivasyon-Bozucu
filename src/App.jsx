...
export default function App() {
  ...
  function getSmallestFontSize(fontObjectOne, fontObjectTwo) {
    const fontSizeOneString = fontObjectOne?.fontSize
    const fontSizeTwoString = fontObjectTwo?.fontSize
  ...
  const smallestFontSize = getSmallestFontSize(
    ...
    >
      {currentData && (
        ...
        >
          <p 
            className='quote' 
            style={{ fontSize: smallestFontSize?.fontSize }} 
          >
